"""
Backtest Engine - Composition Layer (v3.4.1)

Unified backtest engine for all strategies.
Orchestrates core_lib.indicators + strategies.
...
__all__ = ["BacktestEngine", "BacktestResult", "BacktestComparison", "run_backtest", "run_combo_backtest"]
